								...
								function munk_admin_notice_ed() {
								    ...
								    <div class="notice notice-success is-dismissible munk-admin-notice">
												<div class="notice-inner">
													<h3><?php esc_html_e( 'Thanks for installing Munk, you are awesome!', 'munk' ); ?></h3>
													<p><?php esc_html_e( 'We strongly recommend to install and active the Munk Instant Sites plugin.', 'munk'); ?></p>
													<p><?php esc_html_e( 'Munk Sites plugin provides professionally designed Instant Sites that you can easily import into your website directly from your WordPress Dashboard. New Designs Every Week.', 'munk'); ?></p>
													<a href="<?php echo esc_url(admin_url( 'plugin-install.php?s=munk-sites&tab=search&type=term')); ?>" class="button button-primary button-hero"><?php esc_html_e('Install Munk Sites', 'munk'); ?></a>
												</div>
								    </div>
								    <?php
								}
