...
function munk_settings_html( $post) {
	wp_nonce_field( '_munk_settings_nonce', 'munk_settings_nonce' ); ?>
        ...
        <p>
		<input type="checkbox" name="munk_settings_disable_breadcrumbs" id="munk_settings_disable_breadcrumbs" value="disable-breadcrumbs" <?php echo ( munk_settings_get_meta( 'munk_settings_disable_breadcrumbs' ) === 'disable-breadcrumbs' ) ? 'checked' : ''; ?>>
		<label for="munk_settings_disable_breadcrumbs"><?php esc_html_e( 'Disable Breadcrumbs', 'munk' ); ?></label></p>  
		<?php
}
...
function munk_settings_save( $post_id ) {
	...
	if ( isset( $_POST['munk_settings_disable_breadcrumbs'] ) )
		update_post_meta( $post_id, 'munk_settings_disable_breadcrumbs', sanitize_text_field( $_POST['munk_settings_disable_breadcrumbs'] ) ); // phpcs:ignore
	else
		update_post_meta( $post_id, 'munk_settings_disable_breadcrumbs', null );	
}
